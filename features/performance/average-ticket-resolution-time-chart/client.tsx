...
export interface ClientAverageTicketResolutionTimeChartProps {
  data: AverageTicketResolutionTimeChartData;
  dictionary: Pick<Dictionary, "average_ticket_resolution_time_chart">;
}

export function ClientAverageTicketResolutionTimeChart({
  data,
