...
export const unassign: FormAction = async (_, formData) => {
  ...
  try {
    ...
    await prisma.$transaction(async (tx) => {
      ...
      if (!ability.can("unassign", subject("Resource", resource)))
      ...
      await tx.resource.update({
        ...
        data: {
          ...
          traces: {
            create: {
              type: ResourceTraceType.UNASSIGNMENT,
              originId: resource.assignedToId,
